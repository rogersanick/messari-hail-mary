...
import type { GovernorAlphaABI } from "../GovernorAlphaABI";

export class GovernorAlphaABI__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GovernorAlphaABI {
    return new Contract(address, _abi, signerOrProvider) as GovernorAlphaABI;
  }
}
